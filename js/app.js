(() => {
    ...
    (() => {
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-menu")) {
                    ...
                    const firstMenu = document.querySelector(".menu-top__list");
                    firstMenu.classList.toggle("_mm-open");
                }
            }));
        }
        ...
        function rangeInit() {
            const rangeItems = document.querySelectorAll("[data-price]");
            if (rangeItems.length) {
                const priceFrom = document.querySelector("[data-price-from]");
                const priceTo = document.querySelector("[data-price-to]");
                const priceItem = document.querySelector("[data-price-item]");
                const inputs = [ priceFrom, priceTo ];
                nouislider.create(priceItem, {
                    start: [ priceFrom.dataset.priceFrom, priceTo.dataset.priceTo ],
                    connect: true,
                    tooltips: [ true, true ],
                    range: {
                        min: Number(priceFrom.getAttribute("value")),
                        max: Number(priceTo.getAttribute("value"))
                    }
                });
        ...
        function initSliders() {
            if (document.querySelector(".slider-main__slider")) {
                new core(".slider-main__slider", {
                    ...
                    pagination: {
                        el: ".pagination-slider-main__bullets",
                        type: "bullets",
                        clickable: true
                    },
                    on: {
                        init: function allSlides(swiper) {
                            const allSlides = document.querySelector(".fractions-slider-main__total");
                            allSlides.innerHTML = swiper.slides.length;
                        },
                        slideChange: function currentSlide(swiper) {
                            const currentSlide = document.querySelector(".fractions-slider-main__current");
                            currentSlide.innerHTML = swiper.activeIndex + 1 < 10 ? `0${swiper.activeIndex + 1}` : swiper.activeIndex + 1;
                        }
                    }
                });
            }
            if (document.querySelector(".hits-cataloge__slider")) {
                new core(".hits-cataloge__slider", {
                    modules: [ Navigation, Pagination, Autoplay ],
                    observer: true,
                    observeParents: true,
                    spaceBetween: 20,
            ...
            if (document.querySelector(".slider-body-novelties__slider")) {
                new core(".slider-body-novelties__slider", {
                    modules: [ Navigation, Pagination, Autoplay ],
                    observer: true,
                    observeParents: true,
                    spaceBetween: 20,
                    ...
                    pagination: {
                        el: ".slider-body-novelties__pagination",
                        type: "bullets",
                        clickable: true
                    },
                    breakpoints: {
            ...
            if (document.querySelector(".slider-one-body-sales__slider")) {
                new core(".slider-one-body-sales__slider", {
                    modules: [ Navigation, Pagination, Autoplay ],
                    observer: true,
                    observeParents: true,
                    spaceBetween: 20,
                    ...
                    pagination: {
                        el: ".body-sales__slider-one__pagination",
                        type: "bullets",
                        clickable: true
                    },
                    breakpoints: {
            ...
            if (document.querySelector(".slider-two-body-sales__slider")) {
                new core(".slider-two-body-sales__slider", {
                    modules: [ Navigation, Pagination, Autoplay ],
                    observer: true,
                    observeParents: true,
                    spaceBetween: 20,
                    ...
                    pagination: {
                        el: ".body-sales__slider-two__pagination",
                        type: "bullets",
                        clickable: true
                    },
                    breakpoints: {
            ...
            if (document.querySelector(".slider-articles__slider")) {
                new core(".slider-articles__slider", {
                    modules: [ Navigation, Pagination, Autoplay ],
                    observer: true,
                    observeParents: true,
                    spaceBetween: 20,
            ...
            if (document.querySelector(".actions-page-body__slider-wrapper")) {
                new core(".actions-page-body__slider-one", {
                    modules: [ Navigation, Pagination, Autoplay ],
                    observer: true,
                    observeParents: true,
                    spaceBetween: 20,
                    ...
                    pagination: {
                        el: ".actions-page-body__pagination-one",
                        type: "bullets",
                        clickable: true
                    },
                    breakpoints: {
            ...
            if (document.querySelector(".actions-page-body__slider-wrapper")) {
                new core(".actions-page-body__slider-two", {
                    modules: [ Navigation, Pagination, Autoplay ],
                    observer: true,
                    observeParents: true,
                    spaceBetween: 20,
                    ...
                    pagination: {
                        el: ".actions-page-body__pagination-two",
                        type: "bullets",
                        clickable: true
                    },
                    breakpoints: {
        ...
        function showSubMenu(e) {
            if (window.innerWidth > 992) {
                ...
                if (activeLink && !targetElem.closest("[data-parent]")) activeLink.classList.remove("_sub-menu-open");
                if (targetElem.closest("[data-parent]")) {
                    const subMenuId = targetElem.dataset.parent ? targetElem.dataset.parent : null;
                    const subMenu = document.querySelector(`[data-sub="${subMenuId}"]`);
                    if (subMenu) {
                        if (activeLink && activeLink !== targetElem) activeLink.classList.remove("_sub-menu-open");
            ...
            if (window.innerWidth < 992) {
                (function firstLevelMenu(e) {
                    const targetElem = e.target;
                    const subMenuOne = document.querySelector(".bot-menu__list");
                    if (targetElem.closest(".menu-top__item_cataloge")) if (subMenuOne) {
                        subMenuOne.classList.add("_sub-menu-open");
                        e.preventDefault();
                    }
                    if (targetElem.closest(".bot-menu__btn-back")) {
                        const targetElemContainer = targetElem.closest(".bot-menu__list");
                        if (targetElemContainer.closest("._sub-menu-open")) targetElemContainer.classList.remove("_sub-menu-open");
                    }
                })(e);
                (function secondLevelMenu(e) {
                    const targetElem = e.target;
                    if (targetElem.closest("[data-parent]")) {
                        const subMenuId = targetElem.dataset.parent ? targetElem.dataset.parent : null;
                        const subMenu = document.querySelector(`[data-sub="${subMenuId}"]`);
                        const subMenuContainer = subMenu.querySelector(".submenu__container");
                        if (subMenu) {
                            subMenuContainer.classList.add("_sub-menu-open");
                            e.preventDefault();
                        }
                    }
                    if (targetElem.closest(".submenu__btn-back")) {
                        const targetElemContainer = targetElem.closest(".submenu__container");
                        if (targetElemContainer.closest("._sub-menu-open")) targetElemContainer.classList.remove("_sub-menu-open");
                    }
                })(e);
                (function closeAllSubs(e) {
                    const targetElem = e.target;
                    if (targetElem.closest(".icon-menu")) {
                        const activeSubMenu = document.querySelectorAll("._sub-menu-open");
                        activeSubMenu.forEach((item => item.classList.remove("_sub-menu-open")));
                    }
                })(e);
            }
        }
        function dropPhones(e) {
            if (window.innerWidth > 992) {
                const target = e.target;
                const parentItem = document.querySelector(".header-phone i");
                const dropList = document.querySelector(".header-phone__list");
                if (target === parentItem && target.closest(".header-phone")) {
        ...
        function showFilters(e) {
            if (window.innerWidth < 992) {
                ...
                if (filters.classList.contains("_show") && !target.closest(".filters")) {
                    filters.classList.remove("_show");
                    bodyLockToggle();
                }
                if (filters.classList.contains("_show") && target.closest(".filters__close")) {
                    filters.classList.remove("_show");
                    bodyLockToggle();
                }
                if (target.closest(".goods-page__mobile-filter")) {
                    filters.classList.add("_show");
                    bodyLockToggle();
                    e.preventDefault();
                }
            }
